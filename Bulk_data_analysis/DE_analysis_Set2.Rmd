...
total_cnt<- case_rnaseq_data |> dplyr::select(-gene_id,-symbol,-ensembl_id,-Source)
...
genC_file <- case_rnaseq_data |> dplyr::select(-gene_id,-symbol,-ensembl_id,-Source)
#genC_file %>% group_by(ensembl_id) %>% summarise(sample_id[i] = max(sample_id[i]))
 total_cnt <- full_join(total_cnt, genC_file, by = "Name")
...
sn529_counts <- bRNAseq_run1b_count_2T %>% select(meta_sn529$Samp_Name)
sn534_counts <- bRNAseq_run1b_count_2T %>% select(meta_sn534$Samp_Name)
sn677_counts <- bRNAseq_run1b_count_2T %>% select(meta_sn677$Samp_Name)
sn667_counts <- bRNAseq_run1b_count_2T %>% select(meta_sn667$Samp_Name)
...
for(i in 1:length(samp_list)){
  ...
  cell_counts <- bRNAseq_run1b_count_2T %>% select(meta_cell$Samp_Name)
...
if (file.exists(subDir)){
  ...
  cell_alBSigD <- as.data.frame(cell_alBSig) %>% rownames_to_column("GeneID")
  cell_alBSig_A <- right_join(id_mult, cell_alBSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_alBSig_A,"DE_albendazole.txt")
  topGenes_Alb <- list(alb = head(order(cell_alBSig$padj),1000))
  ...
  cell_alBSig_A$delabel[cell_alBSig_A$diffexpressed != "NO"] <-        cell_alBSig_A$Name.x[cell_alBSig_A$diffexpressed != "NO"]
  ...
  print(Al_dif)
  ggplot(data=cell_alBSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_aurNSigD <- as.data.frame(cell_aurNSig) %>% rownames_to_column("GeneID")
  cell_aurNSig_A <- right_join(id_mult, cell_aurNSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_aurNSig_A,"DE_auranofin.txt")
  topGenes_Aur <- list(aur = head(order(cell_aurNSig$padj),1000))
  }
  ...
  cell_aurNSig_A$delabel[cell_aurNSig_A$diffexpressed != "NO"] <-        cell_aurNSig_A$Name.x[cell_aurNSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_aurNSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_bortzSigD <- as.data.frame(cell_bortzSig) %>% rownames_to_column("GeneID")
  cell_bortzSig_A <- right_join(id_mult, cell_bortzSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_bortzSig_A,"DE_bortezomib.txt")
  topGenes_bor <- list(bor = head(order(cell_bortzSig$padj),1000))
  ...
  cell_bortzSig_A$delabel[cell_bortzSig_A$diffexpressed != "NO"] <-        cell_bortzSig_A$Name.x[cell_bortzSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_bortzSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_colcSigD <- as.data.frame(cell_colcSig) %>% rownames_to_column("GeneID")
  cell_colcSig_A <- right_join(id_mult, cell_colcSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_colcSig_A,"DE_colchicine.txt")
  topGenes_col <- list(colc = head(order(cell_colcSig$padj),1000))
  ...
  cell_colcSig_A$delabel[cell_colcSig_A$diffexpressed != "NO"] <-        cell_colcSig_A$Name.x[cell_colcSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_colcSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_disfSigD <- as.data.frame(cell_disfSig) %>% rownames_to_column("GeneID")
  cell_disfSig_A <- right_join(id_mult, cell_disfSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_disfSig_A,"DE_disulfiram.txt")
  topGenes_dsf <- list(disf = head(order(cell_disfSig$padj),1000))
  ...
  cell_disfSig_A$delabel[cell_disfSig_A$diffexpressed != "NO"] <-        cell_disfSig_A$Name.x[cell_disfSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_disfSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_mefqSigD <- as.data.frame(cell_mefqSig) %>% rownames_to_column("GeneID")
  cell_mefqSig_A <- right_join(id_mult, cell_mefqSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_mefqSig_A,"DE_mefloquine.txt")
  topGenes_mef <- list(mefq = head(order(cell_mefqSig$padj),1000))
  ...
  cell_mefqSig_A$delabel[cell_mefqSig_A$diffexpressed != "NO"] <-        cell_mefqSig_A$Name.x[cell_mefqSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_mefqSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_mitoxSigD <- as.data.frame(cell_mitoxSig) %>% rownames_to_column("GeneID")
  cell_mitoxSig_A <- right_join(id_mult, cell_mitoxSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_mitoxSig_A,"DE_mitoxantrone.txt")
  topGenes_mit <- list(mitox = head(order(cell_mitoxSig$padj),1000))
  ...
  cell_mitoxSig_A$delabel[cell_mitoxSig_A$diffexpressed != "NO"] <-        cell_mitoxSig_A$Name.x[cell_mitoxSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_mitoxSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_pitaSigD <- as.data.frame(cell_pitaSig) %>% rownames_to_column("GeneID")
  cell_pitaSig_A <- right_join(id_mult, cell_pitaSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_pitaSig_A,"DE_pitavastatin.txt")
  topGenes_pit <- list(pita = head(order(cell_pitaSig$padj),1000))
  ...
  cell_pitaSig_A$delabel[cell_pitaSig_A$diffexpressed != "NO"] <-        cell_pitaSig_A$Name.x[cell_pitaSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_pitaSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_serSigD <- as.data.frame(cell_serSig) %>% rownames_to_column("GeneID")
  cell_serSig_A <- right_join(id_mult, cell_serSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_serSig_A,"DE_sertraline.txt")
  topGenes_ser <- list(sert = head(order(cell_serSig$padj),1000))
  ...
  cell_serSig_A$delabel[cell_serSig_A$diffexpressed != "NO"] <-        cell_serSig_A$Name.x[cell_serSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_serSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_simvSigD <- as.data.frame(cell_simvSig) %>% rownames_to_column("GeneID")
  cell_simvSig_A <- right_join(id_mult, cell_simvSigD,by =c("Name.y" = "GeneID"))
  write.table(cell_simvSig_A,"DE_simvastatin.txt")
  topGenes_sim <- list(simv = head(order(cell_simvSig$padj),1000))
  ...
  cell_simvSig_A$delabel[cell_simvSig_A$diffexpressed != "NO"] <-        cell_simvSig_A$Name.x[cell_simvSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_simvSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ...
  cell_temSigD <- as.data.frame(cell_temSig) %>% rownames_to_column("GeneID")
  cell_temSig_A <- right_join(id_mult, cell_temSigD,by =c("Name.y"="GeneID"))
  write.table(cell_temSig_A,"DE_temozolomide.txt")
  topGenes_tem <- list(tem = head(order(cell_temSig$padj),1000))
  ...
  cell_temSig_A$delabel[cell_temSig_A$diffexpressed != "NO"] <-        cell_temSig_A$Name.x[cell_temSig_A$diffexpressed != "NO"]
  ...
  ggplot(data=cell_temSig_A, aes(x=log2FoldChange, y=-log10(pvalue), label=delabel, col=diffexpressed)) + geom_point() + theme_minimal() +   geom_text_repel() + scale_color_manual(values=c("blue", "black", "red")) + geom_vline(xintercept=c(-1, 1), col="red") +
geom_hline(yintercept=-log10(0.05), col="red", ) + theme(text = element_text(size= 16))
  ggsave("DE_temozolomide.png", device = "png",units = "in", dpi = 300, height = 4, width = 5)
  }
  #gamy <- paste("top_allDrugs",samp_list[i], sep = "_")
  top_allDrugs[[i]] <- list(tem = topGenes_tem$tem, simv = topGenes_sim$simv, sert = topGenes_ser$sert, pita = topGenes_pit$pita, mitox = topGenes_mit$mitox, mefq = topGenes_mef$mefq, disf = topGenes_dsf$disf, colc = topGenes_col$colc, bor = topGenes_bor$bor, aur = exists("topGenes_Aur$aur", inherit = F), alb = topGenes_Alb$alb)
  #gamy <- paste("top_allDrugs",samp_list[i], sep = "_")
